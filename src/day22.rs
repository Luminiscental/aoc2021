...
type Interval = (i32, i32); // inclusive start, exclusive end
...
mod test_day22 {
    ...
    fn test_day22_examples() {
        assert_eq!(Day22::solve_part1(Day22::parse(EX1)).1, "590784");
        assert_eq!(Day22::solve_part2(Day22::parse(EX2)), "2758514936282235");
    }
}
